...
![[karamazov-orphan-doorway-v5.jpg|right|300]]
<!-- prompt: "19th century Russian literary illustration, black and white mezzotint print, smooth tonal rendering, dramatic chiaroscuro lighting. Inside a pitch-black monastery. A large heavy wooden double door, left side closed, right side swung open. Light enters only through the open half. Through the doorway, a flat open field under gray sky, dark treeline on the horizon. A small young monk in dark robes seen from behind, far out in the field, walking away, tiny against the vast landscape. The interior is pure smooth black, no texture, no hatching, solid darkness everywhere except the door opening. Smooth tonal gradations from light to dark. Refined detail only where lit. Everything else pure black. No borders, no frame, no vignette. Black fills the entire canvas edge to edge." | model: free (gemini-2.5-flash-image) | date: 2026-03-25 -->
<div class="img-caption">"And now, go, my orphan"</div>
...
> [!quote]- "I may not live through this day"
...
> [!quote]- Ferapont on devils in the monastery
...
> [!quote]- Ferapont on bread and the devil
...
> [!quote]- Zosima's last words to Alyosha
...
![[karamazov-third-man-avenue-crosshatch-v6.jpg|right|300]]
<!-- prompt: "Cinematic composition inspired by the final shot of The Third Man (1949). Black and white crosshatched ink drawing, fine pen and ink linework, dense crosshatching for shadows. A long straight WIDE tree-lined avenue, vanishing point dead center. Broad dirt road covered in a THICK CARPET of fallen autumn leaves. Trees far apart, expansive open corridor. Bare autumn trees on BOTH sides, branches overhead against dark grey sky. Behind trees, sparse old Russian Orthodox grave markers — scattered randomly, some tilted, some overgrown. Dim light from the RIGHT — last faint sunset glow. Soft diffused shadows, NOT a grid. Leaves dominant road texture. On the LEFT, SET BACK at mid-near distance, a young monk in black cassock. Body sideways, HEAD turned toward distant figure. Upright, one hand at hip reaching into side pocket. In the FAR distance, a TINY dark silhouette walking AWAY. Autumn dusk, very dark. NO white borders. Dark edges." | model: pro (gemini-3.1-flash-image-preview) | res: 512px | date: 2026-04-10 -->
